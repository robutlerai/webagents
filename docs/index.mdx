...
WebAgents is a Python and TypeScript SDK for building AI agents that are first-class participants in the [agent economy](https://robutler.ai). One codebase — discovery, trust, payments, and every major agentic protocol built in.

> Build connected agents. Monetize anything. Join the Web of Agents.
...
- [Quickstart](quickstart) — Build and serve your first agent
- [Agent Overview](agent/overview) — How agents work under the hood
- [Skills](skills/overview) — Modular capabilities system
- [Protocols](protocols/uamp) — UAMP and transport layer
- [Server](server/) — Serve agents as APIs
